---
title: 反向面试
description: 本文介绍反向面试时应该提问的问题。
date: 2026-01-14T12:34:25-08:00
draft: false
categories:
- 面试
- 个人成长
...
不同情况下面试者需要提出不同的问题来获得更多的信息，推荐在问问题时表露自己对公司及业务的了解。

[技术面试最后反问面试官的话——perkfly/reverse-interview-zh](https://github.com/perkfly/reverse-interview-zh)

## 译者说明

大部分翻译自：[https://github.com/viraptor/reverse-interview](https://github.com/viraptor/reverse-interview) ，亦有其他网友补充。

译者总结的一份适合突击记忆的简洁版 LeetCode 题解和面试问题，也欢迎 Star。[https://github.com/yifeikong/interview](https://github.com/yifeikong/interview)
...
绝对不要想把这个列表里的每个问题都问一遍。（尊重面试官的时间，而且你可以通过查找已经发布的答案来显示你的主动性）
